...
get_resource_upload_url_result=$(az rest -m post -u "https://management.azure.com/subscriptions/$SUBSCRIPTION_ID/resourceGroups/$RESOURCE_GROUP/providers/Microsoft.AppPlatform/Spring/$ASA_SERVICE_NAME/apps/simple-event-driven-app/getResourceUploadUrl?api-version=2023-05-01-preview")
...
source_url="https://github.com/Azure-Samples/ASA-Samples-Event-Driven-Application/releases/download/v0.0.1/simple-event-driven-app-0.0.1.jar"
auth_header="no-auth"
